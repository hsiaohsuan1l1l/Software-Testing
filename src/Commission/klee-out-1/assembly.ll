...
; <label>:26                                      ; preds = %21
  ...
  %35 = sitofp i32 %34 to double, !dbg !133
  store double %35, double* %sales, align 8, !dbg !133
  %36 = load double* %sales, align 8, !dbg !134
  %37 = fcmp oge double %36, 1.800000e+03, !dbg !134
  %38 = load double* %sales, align 8, !dbg !136
  br i1 %37, label %39, label %43, !dbg !134

; <label>:39                                      ; preds = %26
  %40 = fsub double %38, 1.800000e+03, !dbg !136
  %41 = fmul double 2.000000e-01, %40, !dbg !136
  %42 = fadd double 2.200000e+02, %41, !dbg !136
  store double %42, double* %comm, align 8, !dbg !136
  br label %52, !dbg !136

; <label>:43                                      ; preds = %26
  %44 = fcmp oge double %38, 1.000000e+03, !dbg !137
  %45 = load double* %sales, align 8, !dbg !139
  br i1 %44, label %46, label %50, !dbg !137

; <label>:46                                      ; preds = %43
  %47 = fsub double %45, 1.000000e+03, !dbg !139
  %48 = fmul double 1.500000e-01, %47, !dbg !139
  %49 = fadd double 1.000000e+02, %48, !dbg !139
  store double %49, double* %comm, align 8, !dbg !139
  br label %52, !dbg !139

; <label>:50                                      ; preds = %43
  %51 = fmul double 1.000000e-01, %45, !dbg !140
  store double %51, double* %comm, align 8, !dbg !140
  br label %52

; <label>:52                                      ; preds = %46, %50, %39
  %53 = load double* %comm, align 8, !dbg !141
  %54 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([7 x i8]* @.str5, i32 0, i32 0), double %53), !dbg !141
  store i32 0, i32* %1, !dbg !142
  br label %55, !dbg !142

; <label>:55                                      ; preds = %52, %24, %19
  %56 = load i32* %1, !dbg !143
  ret i32 %56, !dbg !143
}
