...
; <label>:15                                      ; preds = %0
  %16 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str3, i32 0, i32 0)), !dbg !125
  br label %17, !dbg !125
...
; <label>:58                                      ; preds = %54
  %59 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str3, i32 0, i32 0)), !dbg !138
  br label %60, !dbg !138
...
; <label>:78                                      ; preds = %69, %72, %75
  ...
  %82 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str4, i32 0, i32 0), i32 %79, i32 %80, i32 %81), !dbg !153
  ret i32 0, !dbg !154
}
